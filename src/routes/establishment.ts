...
router.get('/invitacion', estContext, establecimientoRequireOrgAccess, getInvitation);
...
router.get("/info/opciones-seguimiento", estContext, establecimientoRequireOrgAccess, obtenerOpcionesSeguimiento);
